// Package cli builds the v2ex command tree on top of the v2ex library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: v2ex.DefaultConfig()}

	root := &cobra.Command{
		Use:   "v2ex",
		Short: "Browse V2EX topics, nodes and members",
		Long: `v2ex reads V2EX through its public JSON API.
No API key is required. It returns records as table, JSON, JSONL,
CSV, TSV, or URLs.

v2ex is an independent tool and is not affiliated with V2EX.`,
		SilenceUsage:  true,
		SilenceErrors: true,
