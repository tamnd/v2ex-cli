...
Most of these come down to network reality or how v2ex-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

v2ex-cli rate-limits like any public site. v2ex already paces
...
Where a surface is gated, v2ex reads a cookie or token you supply
...
`v2ex`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what v2ex actually did
